...
const competitions = {
	...
	'Africa Cup': {order: 2, name: 'Africa Cup', sh: 'AF', type: 'H', group: 1, times: [2000, 2002, 2004, 2006, 2008, 2010, 2012, 2013, 2015, 2017, 2019], year: 'single'},
	...
	'WC Qualifiers Europe': {order: 4, name: 'WC Qualifiers Europe', sh: 'WCQ', type: 'Q', group: 0, times: [2016, 2017], spans: [2017]},
	'WC Qualifiers South America': {order: 4, name: 'WC Qualifiers South America', sh: 'WCQ', type: 'Q', group: 0, times: [2015, 2016, 2017], spans: [2017]},
	...
	'Asian Cup Qual.': {order: 2, name: 'Asian Cup Qualifiers', sh: 'ASQ', type: 'Q', group: 1, times: [2013, 2014], url: 'Asian-Cup-Qual', spans: [2014]},
	'Asian Cup Qualifiers': {times: [2013, 2014], url: 'Asian-Cup-Qual'},
	'Nations League A': {order: 6, name: 'Nations League A', sh: 'NL', type: 'Q', group: 1, times: [2018, 2019], spans: [2019]},
	...
	'CONCACAF Nations League A': {order: 6, name: 'CONCACAF Nations League A', sh: 'NL', type: 'Q', group: 1, times: [2019, 2020], spans: [2019]},
	...
	'AFC Champions League': {order: 2, name: 'AFC Champions League', sh: 'ACL', type: '2', group: 0, years: afc.years, year: 'single'},
